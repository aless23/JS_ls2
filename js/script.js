...
// git commit -am "комментарий"  добавляет новый коммит перед этим добавив его в индекс с помощью "а" (аналог команды add)
...
// git diff --staged - позволяет увидеть, какие изменения ожидают файл перед комитом
